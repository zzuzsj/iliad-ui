...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var Se=E`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
...
)}`;const Ze={s:s`<sp-icon-checkmark75 id="checkmark" class="spectrum-UIIcon-Checkmark75"></sp-icon-checkmark75>`,m:s`<sp-icon-checkmark100 id="checkmark" class="spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`,l:s`<sp-icon-checkmark200 id="checkmark" class="spectrum-UIIcon-Checkmark200"></sp-icon-checkmark200>`,xl:s`<sp-icon-checkmark300 id="checkmark" class="spectrum-UIIcon-Checkmark300"></sp-icon-checkmark300>`},qe={s:s`<sp-icon-dash75 id="partialCheckmark" class="spectrum-UIIcon-Dash75"></sp-icon-dash75>`,m:s`<sp-icon-dash100 id="partialCheckmark" class="spectrum-UIIcon-Dash100"></sp-icon-dash100>`,l:s`<sp-icon-dash200 id="partialCheckmark" class="spectrum-UIIcon-Dash200"></sp-icon-dash200>`,xl:s`<sp-icon-dash300 id="partialCheckmark" class="spectrum-UIIcon-Dash300"></sp-icon-dash300>`};class Ee extends(z($e)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Ae,C,Se]}render(){return s`${super.render()} <span id="box">${Ze[this.size]} ${qe[this.size]} </span><label id="label"><slot></slot></label>`}updated(e){super.updated(e),e.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),e.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}l([c({type:Boolean,reflect:!0})],Ee.prototype,"indeterminate",void 0),l([c({type:Boolean,reflect:!0})],Ee.prototype,"invalid",void 0),l([c({type:Boolean,reflect:!0})],Ee.prototype,"emphasized",void 0),h("sp-checkbox",Ee);var _e=E`:host{--spectrum-picker-m-popover-offset-y:var(
--spectrum-global-dimension-size-75
...
)}`;class Ie extends g{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[_e]}render(){return s`<slot></slot>`}}l([c({type:Boolean,reflect:!0})],Ie.prototype,"opened",void 0),l([c({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Ie.prototype,"textOnly",void 0),h("sp-quick-actions",Ie);var Pe=E`:host{--spectrum-card-min-width:var(--spectrum-global-dimension-size-3000);--spectrum-card-border-size:var(--spectrum-alias-border-size-thin);--spectrum-card-border-radius:var(--spectrum-alias-border-radius-regular);--spectrum-card-actions-margin:var(--spectrum-global-dimension-size-125);--spectrum-quickactions-height:var(--spectrum-global-dimension-size-500);--spectrum-card-checkbox-margin:var(--spectrum-global-dimension-size-200);--spectrum-card-coverphoto-height:var(
...
--spectrum-global-dimension-size-50
);--spectrum-divider-margin-size:var(--spectrum-global-dimension-size-100)}:host{margin:var(--spectrum-divider-margin-size) 0}:host{display:block}`;h("sp-menu-divider",class extends g{static get styles(){return[It]}firstUpdated(){this.setAttribute("role","separator")}});var Pt=E`:host{--spectrum-progressbar-s-label-gap-y:var(
--spectrum-global-dimension-size-50
...
);box-shadow:var(--spectrum-panel-box-shadow);padding:0 0 var(--spectrum-panel-padding) 0}:host .panel-header{align-items:center;box-sizing:border-box;display:flex;height:var(--spectrum-panel-header-height);justify-content:space-between;padding:0 var(--spectrum-panel-header-padding-right) 0 var(--spectrum-panel-header-padding-left);width:100%}:host .panel-header[divider]{border-bottom:var(--spectrum-panel-divider-width) solid var(--spectrum-panel-divider-color)}:host .panel-header .header-block{align-items:center;display:flex;height:100%;justify-content:flex-start;overflow:hidden}:host .panel-header .header-block.header-others{justify-content:flex-end}:host .panel-header .header-main .title{color:var(--spectrum-panel-title-color);font-size:var(--spectrum-panel-title-font-size);font-weight:var(--spectrum-panel-title-font-weight);line-height:var(--spectrum-panel-title-line-height);margin-right:var(--spectrum-panel-icon-gap)}:host .panel-header .header-main .back-icon{color:var(--spectrum-panel-icon-main-color);margin-right:var(--spectrum-panel-icon-gap)}:host .panel-header .header-main .close{color:var(--spectrum-panel-icon-others-color);margin-left:var(--spectrum-panel-icon-gap)}::slotted([slot=info]){color:var(--spectrum-panel-icon-others-color)}::slotted([slot=more]){color:var(--spectrum-panel-icon-others-color)}:host .panel-content{height:auto;min-height:var(--spectrum-panel-content-min-height);width:100%}:host .panel-footer{align-items:center;box-sizing:border-box;display:flex;justify-content:flex-end;margin-top:var(--spectrum-panel-footer-margin-top);padding:0 var(--spectrum-panel-padding)}::slotted(*){overscroll-behavior:contain}`;h("sp-icon-editor-arrow-left",class extends i{render(){return Z(s),S`<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.96967 11.4697L13.9697 3.46967L15.0303 4.53033L7.56066 12L15.0303 19.4697L13.9697 20.5303L5.96967 12.5303C5.67678 12.2374 5.67678 11.7626 5.96967 11.4697Z"/></svg>`}});class cr extends(M(H(g,['[slot="info"]','[slot="more"]','[slot="footer"]']))){constructor(){super(...arguments),this.open=!1,this.title="",this.dismissable=!1,this.backable=!1,this.divider=!1,this.cancelLabel="",this.confirmLabel="",this.placement="none",this.tip=!1}static get styles(){return[lr]}get hasFooter(){return this.getSlotContentPresence('[slot="footer"]')}get hasInfo(){return this.getSlotContentPresence('[slot="info"]')}get hasMore(){return this.getSlotContentPresence('[slot="more"]')}doClose(){this.dispatchEvent(new Event("close",{bubbles:!0}))}doBack(){this.dispatchEvent(new Event("back",{bubbles:!0}))}doConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}doCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return s`<div class="panel-header" ?divider="${this.divider}"><div class="header-block header-main ${this.backable?"handle-space":""}">${this.backable?s`<sp-icon-editor-arrow-left class="back-icon" slot="icon" @click="${this.doBack}"></sp-icon-editor-arrow-left>`:s``} ${this.title?s`<h2 class="title">${this.title}</h2>`:s``}<slot name="info"></slot></div><div class="header-block header-others ${this.dismissable?"handle-space":""}"><slot name="more"></slot>${this.dismissable?s`<sp-action-button class="icon close" label="Close" quiet size="m" @click="${this.doClose}"><sp-icon-editor-close class="spectrum-UIIcon-Cross500" slot="icon"></sp-icon-editor-close></sp-action-button>`:s``}</div></div><div class="panel-content"><slot></slot></div>${this.hasFooter?s`<div class="panel-footer"><slot name="footer"></slot></div>`:this.confirmLabel||this.cancelLabel?s`<div class="panel-footer"><sp-button-group class="button-group">${this.cancelLabel?s`<sp-button size="m" variant="primary" @click="${this.doCancel}">${this.cancelLabel}</sp-button>`:s``} ${this.confirmLabel?s`<sp-button size="m" variant="cta" @click="${this.doConfirm}">${this.confirmLabel}</sp-button>`:s``}</sp-button-group></div>`:s``}`}}l([c({type:Boolean,reflect:!0})],cr.prototype,"open",void 0),l([c()],cr.prototype,"title",void 0),l([c({type:Boolean,reflect:!0})],cr.prototype,"dismissable",void 0),l([c({type:Boolean,reflect:!0})],cr.prototype,"backable",void 0),l([c({type:Boolean,reflect:!0})],cr.prototype,"divider",void 0),l([c({attribute:"cancel-label"})],cr.prototype,"cancelLabel",void 0),l([c({attribute:"confirm-label"})],cr.prototype,"confirmLabel",void 0),l([c({reflect:!0})],cr.prototype,"placement",void 0),l([c({type:Boolean,reflect:!0})],cr.prototype,"tip",void 0),h("sp-panel",cr);var nr=E`:host{--spectrum-progressbar-s-label-gap-y:var(
--spectrum-global-dimension-size-50
);--spectrum-progressbar-s-height:var(--spectrum-global-dimension-size-50);--spectrum-progressbar-s-width:var(
--spectrum-global-dimension-static-size-2400
);--spectrum-progressbar-s-indeterminate-fill-width:var(
...
)}`;class Sr extends(z(g)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Ar]}render(){return s`<slot></slot>`}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}l([c({type:Boolean,reflect:!0})],Sr.prototype,"disabled",void 0),l([c({reflect:!0})],Sr.prototype,"variant",void 0),h("sp-status-light",Sr);var Zr=E`:host{--spectrum-switch-m-handle-border-size:var(
--spectrum-alias-border-size-thick
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var qr=E`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class Er extends $e{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[Zr,qr]:[Zr]}render(){return s`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("role","switch")}updated(e){e.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}l([c({type:Boolean,reflect:!0})],Er.prototype,"emphasized",void 0),h("sp-switch",Er);var _r=E`:host{--spectrum-tabs-m-compact-item-height:var(--spectrum-alias-item-height-m);--spectrum-tabs-m-compact-vertical-item-height:var(
--spectrum-global-dimension-size-400
...
--spectrum-breadcrumb-m-item-text-color-down,var(--spectrum-alias-text-color-down)
)}`;h("sp-breadcrumb",class extends g{static get styles(){return[ro]}render(){return s`Markup goes here`}});h("sp-icon-editor-arrow-triangle",class extends i{render(){return Z(s),S`<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M10 17L16 12L10 7L10 17Z"/></svg>`}});var oo=E`:host{--spectrum-tree-item-height:var(--spectrum-alias-control-height-m);--spectrum-tree-item-title-tracking:var(
--spectrum-global-font-letter-spacing-medium
);--spectrum-tree-item-padding-left:var(
--spectrum-global-dimension-size-100
);--spectrum-tree-item-padding-right:var(
--spectrum-global-dimension-size-100
);--spectrum-tree-item-margin-y:var(--spectrum-global-dimension-size-0);--spectrum-tree-item-offset-padding-x:var(
--spectrum-global-dimension-size-0
);--spectrum-tree-item-header-arrow-gap:var(
--spectrum-global-dimension-size-100
);--spectrum-tree-icon-width:var(--spectrum-alias-icon-size-m);--spectrum-tree-icon-height:var(--spectrum-alias-icon-size-m);--spectrum-tree-icon-padding:var(--spectrum-global-dimension-size-0);--spectrum-tree-item-border-size:var(--spectrum-alias-border-size-thin);--spectrum-tree-icon-gap:var(--spectrum-alias-item-workflow-icon-gap-m);--spectrum-tree-item-border-left-size-key-focus:var(
--spectrum-alias-border-size-thick
...
--spectrum-global-font-line-height-medium
);--spectrum-tree-animation-duration:var(
--spectrum-global-animation-duration-100,130ms
...
--spectrum-tree-item-padding-left,var(--spectrum-global-dimension-size-225)
)}:host([dir=rtl]) .indicator{right:var(
--spectrum-tree-item-padding-left,var(--spectrum-global-dimension-size-225)
...
) solid transparent}#heading{box-sizing:border-box;margin:0;margin-bottom:var(--spectrum-tree-item-margin-y);overflow:hidden}:host([dir=ltr]) #header{--indicator-width:calc(var(--spectrum-tree-icon-width) + 2*var(--spectrum-tree-icon-padding));--padding-left:calc(var(
--spectrum-tree-item-padding-left,
var(--spectrum-global-dimension-size-225)
) + var(--indicator-width) + var(
--spectrum-tree-item-header-arrow-gap,
var(--spectrum-global-dimension-size-100)
));padding-left:var(--padding-left);padding-right:var(--spectrum-tree-item-padding-right)}:host([dir=rtl]) #header{--indicator-width:calc(var(--spectrum-tree-icon-width) + 2*var(--spectrum-tree-icon-padding));--padding-right:calc(var(
--spectrum-tree-item-padding-left,
var(--spectrum-global-dimension-size-225)
) + var(--indicator-width) + var(
--spectrum-tree-item-header-arrow-gap,
