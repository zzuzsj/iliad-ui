...
--spectrum-global-color-gray-300
);--spectrum-alias-cover-color-0:transparent;--spectrum-alias-cover-color-100:rgba(0,0,0,.08);--spectrum-alias-cover-color-200:rgba(0,0,0,.16);--spectrum-alias-border-color-100:rgba(0,0,0,.08);--spectrum-alias-border-color-200:rgba(0,0,0,.16);--spectrum-alias-border-color-light:var(--spectrum-alias-border-color-100);--spectrum-alias-border-color-dark:var(--spectrum-alias-border-color-200);--spectrum-alias-text-color-primary:rgba(0,0,0,.88);--spectrum-alias-text-color-secondary:rgba(0,0,0,.72);--spectrum-alias-text-color-placeholder:rgba(0,0,0,.52);--spectrum-alias-text-color-disabled:rgba(0,0,0,.24);--spectrum-alias-text-color-link:#2576f0;--spectrum-alias-icon-color-primary:var(--spectrum-global-color-gray-900);--spectrum-alias-icon-color-secondary:var(
--spectrum-global-color-gray-800
...
--spectrum-global-color-static-primary-700
