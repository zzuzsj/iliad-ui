    ...
    return html`
        ...
        >
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M13 11.75L21 11.75V10.25L14.8107 10.25L21.5303 3.53033L20.4697 2.46967L13.75 9.18934V3L12.25 3V11C12.25 11.1989 12.329 11.3897 12.4697 11.5303C12.6103 11.671 12.8011 11.75 13 11.75ZM11 12.25L3 12.25V13.75L9.18934 13.75L2.46967 20.4697L3.53033 21.5303L10.25 14.8107L10.25 21H11.75V13C11.75 12.8011 11.671 12.6103 11.5303 12.4697C11.3897 12.329 11.1989 12.25 11 12.25Z"
            />
        </svg>
    `;
};
