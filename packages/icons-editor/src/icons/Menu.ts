...
export const MenuIcon = (): string | TemplateResult => {
    return html`
        <svg
            width="24"
            height="24"
        ...
        >
            <g clip-path="url(#clip0_36_102)">
                ...
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M21 5.75H3V4.25H21V5.75ZM21 12.75H3V11.25H21V12.75ZM3 19.75H21V18.25H3V19.75Z"
                />
            </g>
            <defs>
