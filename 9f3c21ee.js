...
--spectrum-alias-workflow-icon-size-s,var(--spectrum-alias-icon-size-s)
);--spectrum-icon-size-m:var(
--spectrum-alias-workflow-icon-size-m,var(--spectrum-alias-icon-size-m)
);--spectrum-icon-size-l:var(--spectrum-alias-icon-size-l);--spectrum-icon-size-xl:var(
--spectrum-alias-workflow-icon-size-xl,var(--spectrum-alias-icon-size-xl)
...
--spectrum-icon-tshirt-size-height,var(--spectrum-alias-workflow-icon-size,var(--spectrum-icon-size-m))
);width:var(
--spectrum-icon-tshirt-size-width,var(--spectrum-alias-workflow-icon-size,var(--spectrum-icon-size-m))
...
--spectrum-global-font-line-height-medium
);--spectrum-panel-title-font-size:var(--spectrum-alias-font-size-m);--spectrum-panel-title-font-weight:var(--spectrum-alias-font-weight-l);--spectrum-panel-translate-x:var(--spectrum-global-dimension-size-0);--spectrum-panel-translate-y:var(--spectrum-global-dimension-size-0)}:host{--spectrum-overlay-animation-distance:var(
