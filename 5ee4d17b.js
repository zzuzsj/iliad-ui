...
)}.visually-hidden{clip:rect(0 0 0 0);-webkit-clip-path:inset(50%);clip-path:inset(50%);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px}:host([dir=ltr]) #label.visually-hidden+.picker{margin-left:auto}:host([dir=rtl]) #label.visually-hidden+.picker{margin-right:auto}`;var ft,kt=o`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
...
)}#container{height:100%}::slotted(*),img,svg{height:100%;vertical-align:top;width:100%}`;class Ct extends ut{static get styles(){return[It]}render(){return U`<slot></slot>`}}let At;s([ot()],Ct.prototype,"label",void 0),s([ot({reflect:!0})],Ct.prototype,"size",void 0);const Et=function(t,...r){return At?At(t,...r):r.reduce(((r,e,o)=>r+e+t[o+1]),t[0])},$t=t=>{At=t};let Bt;mt("sp-icon-chevron100",class extends Ct{render(){return $t(U),Et`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" aria-hidden="true" fill="currentColor"><path d="M3 9.95a.875.875 0 01-.615-1.498L5.88 5 2.385 1.547A.875.875 0 013.615.302L7.74 4.377a.876.876 0 010 1.246L3.615 9.698A.872.872 0 013 9.95z"/></svg>`}});const _t=function(t,...r){return Bt?Bt(t,...r):r.reduce(((r,e,o)=>r+e+t[o+1]),t[0])},Tt=t=>{Bt=t};mt("sp-icon-alert",class extends Ct{render(){return Tt(U),(({width:t=24,height:r=24,hidden:e=!1,title:o="Alert"}={})=>_t`<svg xmlns="http://www.w3.org/2000/svg" height="${r}" viewBox="0 0 36 36" width="${t}" aria-hidden="${e?"true":"false"}" role="img" fill="currentColor" aria-label="${o}"><path d="M17.127 2.579L.4 32.512A1 1 0 001.272 34h33.456a1 1 0 00.872-1.488L18.873 2.579a1 1 0 00-1.746 0zM20 29.5a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5v-3a.5.5 0 01.5-.5h3a.5.5 0 01.5.5zm0-6a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5v-12a.5.5 0 01.5-.5h3a.5.5 0 01.5.5z"/></svg>`)({hidden:!this.label,title:this.label})}});function Ut(t){class r extends t{renderAnchor({id:t,className:r,ariaHidden:e,labelledby:o,tabindex:a,anchorContent:s=U`<slot></slot>`}){return U`<a id="${t}" class="${dt(r)}" href="${dt(this.href)}" download="${dt(this.download)}" target="${dt(this.target)}" aria-label="${dt(this.label)}" aria-labelledby="${dt(o)}" aria-hidden="${dt(e?"true":void 0)}" tabindex="${dt(a)}" rel="${dt(this.rel)}">${s}</a>`}}return s([ot({reflect:!0})],r.prototype,"download",void 0),s([ot()],r.prototype,"label",void 0),s([ot({reflect:!0})],r.prototype,"href",void 0),s([ot({reflect:!0})],r.prototype,"target",void 0),s([ot({reflect:!0})],r.prototype,"rel",void 0),r}mt("sp-icon-checkmark100",class extends Ct{render(){return $t(U),Et`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" aria-hidden="true" fill="currentColor"><path d="M3.5 9.5a.999.999 0 01-.774-.368l-2.45-3a1 1 0 111.548-1.264l1.657 2.028 4.68-6.01A1 1 0 019.74 2.114l-5.45 7a1 1 0 01-.777.386z"/></svg>`}});var St=o`:host{--spectrum-alias-body-text-line-height:var(
...
)}`;class Ft extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0}),this.focused=!1}get item(){return this._item}reset(t){this._item=t}}class Pt extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=t,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const Ht=new Pt,Rt=new Ft;class Mt extends(Ut(zt)){constructor(){super(),this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.noWrap=!1,this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[St,Lt]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}get focusElement(){return this}get itemChildren(){const t=this.shadowRoot.querySelector('slot[name="icon"]'),r=t?t.assignedElements().map((t=>{const r=t.cloneNode(!0);return r.removeAttribute("slot"),r.classList.toggle("icon"),r})):[],e=this.shadowRoot.querySelector("slot:not([name])");return{icon:r,content:e?e.assignedNodes().map((t=>t.cloneNode(!0))):[]}}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(t){if(this.disabled)return t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let t=!1;return this.anchorElement&&(this.anchorElement.click(),t=!0),t}render(){return U`<slot name="icon"></slot><div id="label"><slot id="slot"></slot></div><slot name="value"></slot>${this.selected?U`<sp-icon-checkmark100 id="selected" class="spectrum-UIIcon-Checkmark100 icon checkmark"></sp-icon-checkmark100>`:U``} ${this.href&&this.href.length>0?super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"}):U``}`}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}firstUpdated(t){super.firstUpdated(t),this.setAttribute("tabindex","-1"),this.addEventListener("pointerdown",this.handlePointerdown),this.hasAttribute("id")||(this.id="sp-menu-item-"+Mt.instanceCount++)}updateAriaSelected(){const t=this.getAttribute("role");"option"===t?this.setAttribute("aria-selected",this.selected?"true":"false"):"menuitemcheckbox"!==t&&"menuitemradio"!==t||this.setAttribute("aria-checked",this.selected?"true":"false")}setRole(t){this.setAttribute("role",t),this.updateAriaSelected()}updated(t){super.updated(t),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1),t.has("selected")&&this.updateAriaSelected()}connectedCallback(){super.connectedCallback(),Ht.reset(this),this.dispatchEvent(Ht),this._parentElement=this.parentElement}disconnectedCallback(){var t;Rt.reset(this),null===(t=this._parentElement)||void 0===t||t.dispatchEvent(Rt),super.disconnectedCallback()}async triggerUpdate(){await new Promise((t=>requestAnimationFrame(t))),Ht.reset(this),this.dispatchEvent(Ht)}}Mt.instanceCount=0,s([ot({type:Boolean,reflect:!0})],Mt.prototype,"active",void 0),s([ot({type:Boolean,reflect:!0})],Mt.prototype,"focused",void 0),s([ot({type:Boolean,reflect:!0})],Mt.prototype,"selected",void 0),s([ot({type:String})],Mt.prototype,"value",null),s([ot({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],Mt.prototype,"noWrap",void 0),s([st(".anchor")],Mt.prototype,"anchorElement",void 0);var Ot=o`:host{--spectrum-alias-body-text-line-height:var(
--spectrum-global-font-line-height-medium
);--spectrum-listitem-m-divider-size:var(--spectrum-alias-border-size-thin);--spectrum-listitem-m-divider-padding:3px;--spectrum-listitem-m-focus-indicator-size:var(
--spectrum-global-dimension-size-0
);--spectrum-listitem-m-text-font-weight:var(
...
--spectrum-alias-workflow-icon-size-m,var(--spectrum-global-dimension-size-225)
)}`;class cr extends ar{static get styles(){return[sr]}}var ir=o`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
);--spectrum-alias-focus-ring-gap:var(
--spectrum-global-dimension-static-size-25
);--spectrum-logicbutton-and-height:24px;--spectrum-logicbutton-and-padding-x:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;class lr extends(pt(cr)){constructor(){super(...arguments),this.variant="cta",this.warning=!1,this.quiet=!1}static get styles(){return[...super.styles,ir]}}s([ot({reflect:!0})],lr.prototype,"variant",void 0),s([ot({type:Boolean,reflect:!0})],lr.prototype,"warning",void 0),s([ot({type:Boolean,reflect:!0})],lr.prototype,"quiet",void 0),mt("sp-button",lr);var nr=o`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
);--spectrum-alias-focus-ring-gap:var(
--spectrum-global-dimension-static-size-25
);--spectrum-logicbutton-and-height:24px;--spectrum-logicbutton-and-padding-x:var(
...
--spectrum-button-quiet-over-background-m-text-color-disabled,hsla(0,0%,100%,.15)
)}`;mt("sp-icon-cross75",class extends Ct{render(){return $t(U),Et`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8" aria-hidden="true" fill="currentColor"><path d="M5.188 4l2.14-2.14A.84.84 0 106.141.672L4 2.812 1.86.672A.84.84 0 00.672 1.86L2.812 4 .672 6.14A.84.84 0 101.86 7.328L4 5.188l2.14 2.14A.84.84 0 107.328 6.14z"/></svg>`}});var ur=o`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
);--spectrum-alias-ui-icon-doublegripper-size-100-width:var(
--spectrum-global-dimension-size-200
);--spectrum-alias-ui-icon-singlegripper-size-100-width:var(
...
)}`;class mr extends cr{constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,nr,ur]}get buttonContent(){return[U`<sp-icon-cross75 slot="icon" class="icon spectrum-UIIcon-Cross75"></sp-icon-cross75>`]}}s([ot({reflect:!0})],mr.prototype,"variant",void 0);var pr=o`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;var dr=o`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
);--spectrum-alias-ui-icon-doublegripper-size-100-width:var(
--spectrum-global-dimension-size-200
);--spectrum-alias-ui-icon-singlegripper-size-100-width:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;mt("sp-icon-corner-triangle300",class extends Ct{render(){return $t(U),Et`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 7" aria-hidden="true" fill="currentColor"><path d="M6.683.67a.315.315 0 00-.223.093l-5.7 5.7a.316.316 0 00.224.54h5.7A.316.316 0 007 6.687V.986A.316.316 0 006.684.67z"/></svg>`}});const br={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let vr;class gr extends(pt(ar)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[pr,dr]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),vr=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(vr),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:r,altKey:e}=t;("Space"===r||e&&"ArrowDown"===r)&&(t.preventDefault(),"ArrowDown"===r&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:r,altKey:e}=t;("Space"===r||e&&"ArrowDown"===r)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(U`<sp-icon-corner-triangle300 id="hold-affordance" class="${br[this.size]}"></sp-icon-corner-triangle300>`),t}updated(t){super.updated(t),this.toggles&&t.has("selected")&&this.focusElement.setAttribute("aria-pressed",this.selected?"true":"false")}}s([ot({type:Boolean,reflect:!0})],gr.prototype,"emphasized",void 0),s([ot({type:Boolean,reflect:!0,attribute:"hold-affordance"})],gr.prototype,"holdAffordance",void 0),s([ot({type:Boolean,reflect:!0})],gr.prototype,"quiet",void 0),s([ot({type:Boolean,reflect:!0})],gr.prototype,"selected",void 0),s([ot({type:Boolean,reflect:!0})],gr.prototype,"toggles",void 0),s([ot({type:String})],gr.prototype,"value",null),mt("sp-action-button",gr);mt("sp-icon-asterisk100",class extends Ct{render(){return $t(U),Et`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8" aria-hidden="true" fill="currentColor"><path d="M6.575 6.555c.055.056.092.13 0 .2l-1.149.741c-.092.056-.129.019-.166-.074L3.834 4.94 1.963 7c-.019.036-.074.073-.129 0l-.889-.927c-.093-.055-.074-.111 0-.166l2.111-1.76L.648 3.24c-.037 0-.092-.074-.056-.167l.63-1.259a.097.097 0 01.167-.036L3.5 3.148l.13-2.7a.1.1 0 01.081-.111.15.15 0 01.03 0l1.537.2c.093 0 .111.037.093.13l-.723 2.647 2.445-.741c.055-.037.111-.037.148.074l.241 1.37c.018.093 0 .13-.074.13l-2.556.2z"/></svg>`}});var hr=o`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
);--spectrum-alias-ui-icon-doublegripper-size-100-width:var(
--spectrum-global-dimension-size-200
);--spectrum-alias-ui-icon-singlegripper-size-100-width:var(
...
)}`;var yr=o`:host{--spectrum-fieldlabel-s-text-font-weight:var(
--spectrum-alias-font-weight-m
...
)}`;class fr extends(pt(ut)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[yr,hr]}handleClick(t){if(!this.target||this.disabled||t.defaultPrevented)return;this.target.focus();const r=this.getRootNode(),e=this.target,o=e.getRootNode(),a=o.host;o===r&&e.forceFocusVisible?e.forceFocusVisible():a&&a.forceFocusVisible&&a.forceFocusVisible()}async manageFor(){if(!this.for)return;const t=this.getRootNode(),r=t.querySelector(`#${this.for}`);if(r){if(r.localName.search("-")>0&&await customElements.whenDefined(r.localName),void 0!==r.updateComplete&&await r.updateComplete,this.target=r.focusElement||r,this.target){this.target.getRootNode()===t?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",this.labelText)}return Promise.resolve()}}get labelText(){const t=this.slotEl.assignedNodes({flatten:!0});if(!t.length)return"";return t.map((t=>(t.textContent||"").trim())).join(" ")}render(){return U`<label><slot @slotchange="${this.manageFor}"></slot>${this.required?U`<sp-icon-asterisk100 class="requiredIcon spectrum-UIIcon-Asterisk100"></sp-icon-asterisk100>`:U``}</label>`}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${fr.instanceCount++}`),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),(t.has("for")||t.has("id"))&&this.manageFor()}}fr.instanceCount=0,s([ot({type:Boolean,reflect:!0})],fr.prototype,"disabled",void 0),s([ot({type:String})],fr.prototype,"id",void 0),s([ot({type:String})],fr.prototype,"for",void 0),s([ot({type:Boolean,reflect:!0})],fr.prototype,"required",void 0),s([st("slot")],fr.prototype,"slotEl",void 0),s([ot({type:String,reflect:!0,attribute:"side-aligned"})],fr.prototype,"sideAligned",void 0),mt("sp-field-label",fr),mt("sp-menu-item",Mt);var kr=o`:host{--spectrum-link-primary-s-text-size:var(--spectrum-alias-item-text-size-s);--spectrum-link-primary-m-text-size:var(--spectrum-alias-item-text-size-m);--spectrum-link-primary-l-text-size:var(--spectrum-alias-item-text-size-l);--spectrum-link-primary-xl-text-size:var(
...
)}@media (forced-colors:active){:host([variant=secondary]) a{color:linktext}:host([variant=secondary]) a:hover{color:linktext}:host([variant=secondary]) a:active{color:linktext}:host([variant=secondary]) a:focus{color:linktext}}:host{display:inline}:host(:focus){outline:0}:host([href]) a.focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}:host([href]) a:focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}`;class xr extends(pt(Ut(zt),{noDefaultSize:!0})){static get styles(){return[kr]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}s([st("#anchor")],xr.prototype,"anchorElement",void 0),s([ot({type:String,reflect:!0})],xr.prototype,"variant",void 0),mt("sp-link",xr);var wr=o`:host{--spectrum-divider-s-height:var(--spectrum-global-dimension-size-10);--spectrum-divider-s-vertical-width:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class zr extends(pt(ut,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return U``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}zr.styles=[wr],s([ot({type:Boolean,reflect:!0})],zr.prototype,"vertical",void 0),mt("sp-divider",zr),mt("sp-clear-button",mr);mt("sp-icon-info",class extends Ct{render(){return Tt(U),(({width:t=24,height:r=24,hidden:e=!1,title:o="Info"}={})=>_t`<svg xmlns="http://www.w3.org/2000/svg" height="${r}" viewBox="0 0 36 36" width="${t}" aria-hidden="${e?"true":"false"}" role="img" fill="currentColor" aria-label="${o}"><path d="M18 2a16 16 0 1016 16A16 16 0 0018 2zm-.3 4.3a2.718 2.718 0 012.864 2.824 2.664 2.664 0 01-2.864 2.863 2.705 2.705 0 01-2.864-2.864A2.717 2.717 0 0117.7 6.3zM22 27a1 1 0 01-1 1h-6a1 1 0 01-1-1v-2a1 1 0 011-1h1v-6h-1a1 1 0 01-1-1v-2a1 1 0 011-1h4a1 1 0 011 1v9h1a1 1 0 011 1z"/></svg>`)({hidden:!this.label,title:this.label})}});mt("sp-icon-checkmark-circle",class extends Ct{render(){return Tt(U),(({width:t=24,height:r=24,hidden:e=!1,title:o="Checkmark Circle"}={})=>_t`<svg xmlns="http://www.w3.org/2000/svg" height="${r}" viewBox="0 0 36 36" width="${t}" aria-hidden="${e?"true":"false"}" role="img" fill="currentColor" aria-label="${o}"><path d="M18 2a16 16 0 1016 16A16 16 0 0018 2zm10.666 9.08L16.018 27.341a1.206 1.206 0 01-.875.461h-.073a1.2 1.2 0 01-.849-.351l-7.785-7.793a1.2 1.2 0 010-1.7l1.326-1.325a1.2 1.2 0 011.7 0l5.338 5.349L25.314 8.473A1.2 1.2 0 0127 8.263L28.455 9.4a1.2 1.2 0 01.211 1.68z"/></svg>`)({hidden:!this.label,title:this.label})}});var qr=o`:host{--spectrum-toast-neutral-padding-right:var(
--spectrum-global-dimension-size-100
...
--spectrum-toast-positive-background-color,var(--spectrum-semantic-positive-color-background)
)}.content{line-height:1.5}:host(:not([open])){display:none}`;const Ir=["negative","positive","info","error","warning"];class Cr extends ut{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.open=!1,this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[qr]}set timeout(t){const r=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;Ir.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return U`<sp-icon-info label="Information" class="type"></sp-icon-info>`;case"negative":case"error":case"warning":return U`<sp-icon-alert label="Error" class="type"></sp-icon-alert>`;case"positive":case"success":return U`<sp-icon-checkmark-circle label="Success" class="type"></sp-icon-checkmark-circle>`;default:return U``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}close(){this.open=!1}render(){return U`${this.renderIcon(this.variant)}<div class="body" role="alert"><div class="content"><slot></slot></div><slot name="action"></slot></div><div class="buttons"><sp-clear-button label="Close" variant="overBackground" @click="${this.close}"></sp-clear-button></div>`}updated(t){if(super.updated(t),t.has("open"))if(this.open)this.timeout&&this.startCountdown();else{this.timeout&&this.stopCountdown();this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))||(this.open=!0)}t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}s([ot({type:Boolean,reflect:!0})],Cr.prototype,"open",void 0),s([ot({type:Number})],Cr.prototype,"timeout",null),s([ot({type:String})],Cr.prototype,"variant",null),mt("sp-toast",Cr);export{U as $,wt as F,Ct as I,Ut as L,Dt as M,Jt as O,er as P,X as R,ut as S,s as _,tt as a,st as b,vt as c,gt as d,ot as e,bt as f,L as g,zt as h,mt as i,lt as j,kt as k,dt as l,Et as m,$t as n,tr as o,pt as p,Lt as q,Yt as r,Tt as s,_t as t,ur as u,a as v,F as w,ht as x,S as y,qt as z};
//# sourceMappingURL=5ee4d17b.js.map
