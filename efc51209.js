...
)}.visually-hidden{clip:rect(0 0 0 0);-webkit-clip-path:inset(50%);clip-path:inset(50%);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px}:host([dir=ltr]) #label.visually-hidden+.picker{margin-left:auto}:host([dir=rtl]) #label.visually-hidden+.picker{margin-right:auto}`;var ht,yt=o`:host{--spectrum-alias-workflow-icon-size-s:var(
...
--spectrum-global-color-gray-400-cover-100
...
--spectrum-global-color-gray-400-cover-200
...
--spectrum-global-color-gray-300
);--spectrum-button-secondary-m-border-color:var(--spectrum-global-gray-300);--spectrum-button-secondary-m-text-color:var(
--spectrum-alias-text-color-secondary
);--spectrum-button-secondary-m-background-color-hover:var(
--spectrum-global-color-gray-300-cover-100
...
--spectrum-global-color-gray-300-cover-200
...
--spectrum-global-color-red-cover-100
...
--spectrum-global-color-red-cover-200
...
--spectrum-button-quiet-over-background-m-text-color-disabled,hsla(0,0%,100%,.15)
)}`;nt("sp-icon-cross75",class extends qt{render(){return At(U),Ct`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8" aria-hidden="true" fill="currentColor"><path d="M5.188 4l2.14-2.14A.84.84 0 106.141.672L4 2.812 1.86.672A.84.84 0 00.672 1.86L2.812 4 .672 6.14A.84.84 0 101.86 7.328L4 5.188l2.14 2.14A.84.84 0 107.328 6.14z"/></svg>`}});var lr=o`:host{--spectrum-alias-workflow-icon-size-s:var(
--spectrum-global-dimension-size-200
);--spectrum-alias-workflow-icon-size-m:var(
--spectrum-global-dimension-size-225
);--spectrum-alias-workflow-icon-size-xl:var(
...
--spectrum-alias-border-radius-medium
);--spectrum-actionbutton-s-min-width:var(
--spectrum-global-dimension-size-400
);--spectrum-actionbutton-s-text-font-weight:var(
--spectrum-alias-body-text-font-weight
);--spectrum-actionbutton-s-text-line-height:var(
--spectrum-alias-component-text-line-height
);--spectrum-actionbutton-s-text-size:var(--spectrum-alias-item-text-size-s);--spectrum-actionbutton-s-icon-gap:var(
--spectrum-alias-item-workflow-icon-gap-s
...
--spectrum-alias-border-radius-medium
);--spectrum-actionbutton-m-min-width:var(
--spectrum-global-dimension-size-400
);--spectrum-actionbutton-m-text-font-weight:var(
--spectrum-alias-body-text-font-weight
);--spectrum-actionbutton-m-text-line-height:var(
--spectrum-alias-component-text-line-height
);--spectrum-actionbutton-m-text-size:var(--spectrum-alias-item-text-size-m);--spectrum-actionbutton-m-height:var(--spectrum-alias-item-height-m);--spectrum-actionbutton-m-icon-gap:var(
--spectrum-alias-item-workflow-icon-gap-s
...
--spectrum-alias-border-radius-medium
);--spectrum-actionbutton-l-min-width:var(
--spectrum-global-dimension-size-400
);--spectrum-actionbutton-l-text-font-weight:var(
--spectrum-alias-body-text-font-weight
);--spectrum-actionbutton-l-text-line-height:var(
--spectrum-alias-component-text-line-height
);--spectrum-actionbutton-l-text-size:var(--spectrum-alias-item-text-size-l);--spectrum-actionbutton-l-icon-gap:var(
--spectrum-alias-item-workflow-icon-gap-l
...
);--spectrum-actionbutton-xl-text-size:var(
--spectrum-alias-item-text-size-xl
);--spectrum-actionbutton-xl-height:var(--spectrum-alias-item-height-xl);--spectrum-actionbutton-xl-padding-left:var(--spectrum-alias-padding-xl);--spectrum-actionbutton-xl-icononly-padding-left:var(
--spectrum-alias-padding-xl
...
--spectrum-global-color-gray-100-cover-100
...
--spectrum-global-color-gray-100-cover-200
...
);border-color:var(--spectrum-actionbutton-m-background-color);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-hover);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-key-focus);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-down);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-disabled);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-selected);color:var(
...
--spectrum-actionbutton-m-background-color-selected-hover
);color:var(
...
);border-color:var(--spectrum-actionbutton-m-background-color-selected-down);color:var(
...
--spectrum-actionbutton-m-background-color-selected-disabled
);color:var(
...
);border-color:var(--spectrum-actionbutton-m-emphasized-background-color);color:var(
...
--spectrum-actionbutton-m-emphasized-background-color-hover
);color:var(
...
--spectrum-actionbutton-m-emphasized-background-color-disabled
);color:var(
...
--spectrum-actionbutton-m-emphasized-background-color-selected
);color:var(
...
--spectrum-actionbutton-m-emphasized-background-color-selected-disabled
);color:var(
...
);border-color:var(--spectrum-actionbutton-m-quiet-background-color);color:var(
...
);border-color:var(--spectrum-actionbutton-m-quiet-background-color-hover);color:var(
...
);border-color:var(--spectrum-actionbutton-m-quiet-background-color-down);color:var(
...
--spectrum-actionbutton-m-quiet-background-color-disabled
);color:var(
...
--spectrum-actionbutton-m-quiet-background-color-selected
);color:var(
...
--spectrum-actionbutton-m-quiet-background-color-selected-hover
);color:var(
...
--spectrum-actionbutton-m-quiet-background-color-selected-down
);color:var(
...
--spectrum-actionbutton-m-quiet-background-color-selected-disabled
);color:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;var mr=o`:host{--spectrum-alias-workflow-icon-size-s:var(
--spectrum-global-dimension-size-200
);--spectrum-alias-workflow-icon-size-m:var(
--spectrum-global-dimension-size-225
);--spectrum-alias-workflow-icon-size-xl:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class xr extends(ut(lt,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return U``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}xr.styles=[kr],s([ot({type:Boolean,reflect:!0})],xr.prototype,"vertical",void 0),nt("sp-divider",xr),nt("sp-clear-button",nr);nt("sp-icon-info",class extends qt{render(){return Bt(U),(({width:t=24,height:r=24,hidden:e=!1,title:o="Info"}={})=>$t`<svg xmlns="http://www.w3.org/2000/svg" height="${r}" viewBox="0 0 36 36" width="${t}" aria-hidden="${e?"true":"false"}" role="img" fill="currentColor" aria-label="${o}"><path d="M18 2a16 16 0 1016 16A16 16 0 0018 2zm-.3 4.3a2.718 2.718 0 012.864 2.824 2.664 2.664 0 01-2.864 2.863 2.705 2.705 0 01-2.864-2.864A2.717 2.717 0 0117.7 6.3zM22 27a1 1 0 01-1 1h-6a1 1 0 01-1-1v-2a1 1 0 011-1h1v-6h-1a1 1 0 01-1-1v-2a1 1 0 011-1h4a1 1 0 011 1v9h1a1 1 0 011 1z"/></svg>`)({hidden:!this.label,title:this.label})}});nt("sp-icon-checkmark-circle",class extends qt{render(){return Bt(U),(({width:t=24,height:r=24,hidden:e=!1,title:o="Checkmark Circle"}={})=>$t`<svg xmlns="http://www.w3.org/2000/svg" height="${r}" viewBox="0 0 36 36" width="${t}" aria-hidden="${e?"true":"false"}" role="img" fill="currentColor" aria-label="${o}"><path d="M18 2a16 16 0 1016 16A16 16 0 0018 2zm10.666 9.08L16.018 27.341a1.206 1.206 0 01-.875.461h-.073a1.2 1.2 0 01-.849-.351l-7.785-7.793a1.2 1.2 0 010-1.7l1.326-1.325a1.2 1.2 0 011.7 0l5.338 5.349L25.314 8.473A1.2 1.2 0 0127 8.263L28.455 9.4a1.2 1.2 0 01.211 1.68z"/></svg>`)({hidden:!this.label,title:this.label})}});var wr=o`:host{--spectrum-toast-neutral-padding-right:var(
--spectrum-global-dimension-size-100
...
--spectrum-toast-positive-background-color,var(--spectrum-semantic-positive-color-background)
)}.content{line-height:1.5}:host(:not([open])){display:none}`;const zr=["negative","positive","info","error","warning"];class qr extends lt{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.open=!1,this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[wr]}set timeout(t){const r=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;zr.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return U`<sp-icon-info label="Information" class="type"></sp-icon-info>`;case"negative":case"error":case"warning":return U`<sp-icon-alert label="Error" class="type"></sp-icon-alert>`;case"positive":case"success":return U`<sp-icon-checkmark-circle label="Success" class="type"></sp-icon-checkmark-circle>`;default:return U``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}close(){this.open=!1}render(){return U`${this.renderIcon(this.variant)}<div class="body" role="alert"><div class="content"><slot></slot></div><slot name="action"></slot></div><div class="buttons"><sp-clear-button label="Close" variant="overBackground" @click="${this.close}"></sp-clear-button></div>`}updated(t){if(super.updated(t),t.has("open"))if(this.open)this.timeout&&this.startCountdown();else{this.timeout&&this.stopCountdown();this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))||(this.open=!0)}t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}s([ot({type:Boolean,reflect:!0})],qr.prototype,"open",void 0),s([ot({type:Number})],qr.prototype,"timeout",null),s([ot({type:String})],qr.prototype,"variant",null),nt("sp-toast",qr);export{kt as F,qt as I,_t as L,Ot as M,Qt as O,tr as P,X as R,lt as S,F as T,s as _,tt as a,st as b,dt as c,bt as d,ot as e,pt as f,L as g,xt as h,nt as i,ct as j,yt as k,mt as l,Ct as m,At as n,Zt as o,U as p,ut as q,Ut as r,Bt as s,$t as t,Gt as u,lr as v,a as w,vt as x,S as y,wt as z};
//# sourceMappingURL=efc51209.js.map
