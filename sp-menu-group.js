import { r, S as SpectrumElement, p, _ as __decorate, e, i as iliadCustomElementsDefine, o } from './Theme.js';
import { M as Menu } from './sp-toast.js';

const styles$5=r`:host{--spectrum-alias-body-text-font-family:var(
...
const styles$4=r`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
);--spectrum-alias-font-size-default:var(
--spectrum-global-dimension-font-size-100
);--spectrum-alias-font-family-ar:myriad-arabic,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-he:myriad-hebrew,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-zhhans:adobe-clean-han-simplified-c,source-han-simplified-c,"SimSun","Heiti SC Light","sans-serif";--spectrum-alias-font-family-zh:adobe-clean-han-traditional,source-han-traditional,"MingLiu","Heiti TC Light","sans-serif";--spectrum-alias-font-family-ko:adobe-clean-han-korean,source-han-korean,"Malgun Gothic","Apple Gothic","sans-serif";--spectrum-alias-font-family-ja:adobe-clean-han-japanese,source-han-japanese,"Yu Gothic","\30E1 \30A4 \30EA \30AA","\30D2 \30E9 \30AE \30CE \89D2 \30B4  Pro W3","Hiragino Kaku Gothic Pro W3","Osaka","\FF2D \FF33 \FF30 \30B4 \30B7 \30C3 \30AF","MS PGothic","sans-serif";--spectrum-heading-xxxl-text-size:var(
...
const styles$3=r`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
);--spectrum-alias-font-size-default:var(
--spectrum-global-dimension-font-size-100
);--spectrum-alias-font-family-ar:myriad-arabic,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-he:myriad-hebrew,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-zhhans:adobe-clean-han-simplified-c,source-han-simplified-c,"SimSun","Heiti SC Light","sans-serif";--spectrum-alias-font-family-zh:adobe-clean-han-traditional,source-han-traditional,"MingLiu","Heiti TC Light","sans-serif";--spectrum-alias-font-family-ko:adobe-clean-han-korean,source-han-korean,"Malgun Gothic","Apple Gothic","sans-serif";--spectrum-alias-font-family-ja:adobe-clean-han-japanese,source-han-japanese,"Yu Gothic","\30E1 \30A4 \30EA \30AA","\30D2 \30E9 \30AE \30CE \89D2 \30B4  Pro W3","Hiragino Kaku Gothic Pro W3","Osaka","\FF2D \FF33 \FF30 \30B4 \30B7 \30C3 \30AF","MS PGothic","sans-serif";--spectrum-heading-xxxl-text-size:var(
...
var headingStyles = [styles$5,styles$4,styles$3];

const styles$2=r`:host{--spectrum-illustrated-message-description-max-width:500px;--spectrum-illustrated-message-heading-max-width:500px;--spectrum-illustrated-message-illustration-margin-bottom:24px;--spectrum-illustrated-message-heading-margin:0;--spectrum-illustrated-message-description-margin:4px 0 0 0}:host{align-items:center;display:flex;flex-direction:column;height:100%;justify-content:center;text-align:center}#illustration{margin-bottom:var(
...
const styles$1=r`:host{--spectrum-alias-body-text-font-family:var(
--spectrum-global-font-family-base
);--spectrum-alias-font-size-default:var(
--spectrum-global-dimension-font-size-100
);--spectrum-alias-font-family-ar:myriad-arabic,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-he:myriad-hebrew,adobe-clean,"Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Ubuntu,"Trebuchet MS","Lucida Grande",sans-serif;--spectrum-alias-font-family-zhhans:adobe-clean-han-simplified-c,source-han-simplified-c,"SimSun","Heiti SC Light","sans-serif";--spectrum-alias-font-family-zh:adobe-clean-han-traditional,source-han-traditional,"MingLiu","Heiti TC Light","sans-serif";--spectrum-alias-font-family-ko:adobe-clean-han-korean,source-han-korean,"Malgun Gothic","Apple Gothic","sans-serif";--spectrum-alias-font-family-ja:adobe-clean-han-japanese,source-han-japanese,"Yu Gothic","\30E1 \30A4 \30EA \30AA","\30D2 \30E9 \30AE \30CE \89D2 \30B4  Pro W3","Hiragino Kaku Gothic Pro W3","Osaka","\FF2D \FF33 \FF30 \30B4 \30B7 \30C3 \30AF","MS PGothic","sans-serif";--spectrum-heading-xxxl-text-size:var(
...
var bodyStyles = [styles$5,styles$4,styles$1];
 ...
 */class IllustratedMessage extends SpectrumElement{constructor(){super(...arguments);this.heading='';this.description='';}static get styles(){return [headingStyles,bodyStyles,styles$2];}render(){return p`<div id="illustration"><slot></slot></div><h2 id="heading" class="spectrum-Heading spectrum-Heading--sizeL spectrum-Heading--light"><slot name="heading">${this.heading}</slot></h2><div id="description" class="spectrum-Body spectrum-Body--sizeS"><slot name="description">${this.description}</slot></div>`;}}IllustratedMessage.is='sp-illustrated-message';__decorate([e()],IllustratedMessage.prototype,"heading",void 0);__decorate([e()],IllustratedMessage.prototype,"description",void 0);

iliadCustomElementsDefine('sp-illustrated-message',IllustratedMessage);

const styles=r`.header{color:var(--spectrum-listheading-text-color);display:block;font-size:var(--spectrum-listitem-heading-text-size);font-weight:var(--spectrum-listitem-heading-text-font-weight);letter-spacing:var(
...
)}:host{display:inline;margin:0;overflow:visible}:host([dir=ltr]) .header{padding:0 var(--spectrum-alias-padding-l) 0 var(--spectrum-alias-padding-m)}:host([dir=rtl]) .header{padding:0 var(--spectrum-alias-padding-m) 0 var(--spectrum-alias-padding-l)}sp-menu{display:block}`;
 ...
 */class MenuGroup extends Menu{constructor(){super();MenuGroup.instances+=1;this.headerId=`sp-menu-group-label-${MenuGroup.instances}`;}static get styles(){return [...super.styles,styles];}get ownRole(){switch(this.selects){case'multiple':case'single':case'inherit':return 'group';default:return 'menu';}}updateLabel(){const headerElement=this.headerElements.length?this.headerElements[0]:undefined;if(headerElement!==this.headerElement){if(this.headerElement&&this.headerElement.id===this.headerId){this.headerElement.removeAttribute('id');}if(headerElement){const headerId=headerElement.id||this.headerId;if(!headerElement.id){headerElement.id=headerId;}this.setAttribute('aria-labelledby',headerId);}else {this.removeAttribute('aria-labelledby');}}this.headerElement=headerElement;}render(){return p`<span class="header" aria-hidden="true"><slot name="header" @slotchange="${this.updateLabel}"></slot></span><sp-menu role="none"><slot></slot></sp-menu>`;}}MenuGroup.instances=0;__decorate([o('header',true)],MenuGroup.prototype,"headerElements",void 0);

iliadCustomElementsDefine('sp-menu-group',MenuGroup);

export { styles$4 as a, headingStyles as h, styles$5 as s };
