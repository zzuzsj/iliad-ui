...
)}:host{display:block;overflow:hidden}img{height:auto;vertical-align:top;width:100%}`;class Le extends g{constructor(){super(...arguments),this.label="",this.src=""}static get styles(){return[Ce]}render(){return s`<img alt="${a(this.label||void 0)}" src="${this.src}">`}}l([c()],Le.prototype,"label",void 0),l([c()],Le.prototype,"src",void 0),h("sp-avatar",Le);var He=q`:host{--spectrum-banner-border-radius:var(
...
)}`;class Me extends g{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[He]}render(){return s`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}l([c({reflect:!0,type:String})],Me.prototype,"type",void 0),l([c({reflect:!0,type:Boolean})],Me.prototype,"corner",void 0),h("sp-banner",Me);var Ve=q`:host{--spectrum-buttongroup-button-gap-x:var(
--spectrum-global-dimension-size-100
...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var Ae=q`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
...
)}`;const Se={s:s`<sp-icon-checkmark75 id="checkmark" class="spectrum-UIIcon-Checkmark75"></sp-icon-checkmark75>`,m:s`<sp-icon-checkmark100 id="checkmark" class="spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`,l:s`<sp-icon-checkmark200 id="checkmark" class="spectrum-UIIcon-Checkmark200"></sp-icon-checkmark200>`,xl:s`<sp-icon-checkmark300 id="checkmark" class="spectrum-UIIcon-Checkmark300"></sp-icon-checkmark300>`},Ee={s:s`<sp-icon-dash75 id="partialCheckmark" class="spectrum-UIIcon-Dash75"></sp-icon-dash75>`,m:s`<sp-icon-dash100 id="partialCheckmark" class="spectrum-UIIcon-Dash100"></sp-icon-dash100>`,l:s`<sp-icon-dash200 id="partialCheckmark" class="spectrum-UIIcon-Dash200"></sp-icon-dash200>`,xl:s`<sp-icon-dash300 id="partialCheckmark" class="spectrum-UIIcon-Dash300"></sp-icon-dash300>`};class qe extends(k(Ze)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[$e,C,Ae]}render(){return s`${super.render()} <span id="box">${Se[this.size]} ${Ee[this.size]} </span><label id="label"><slot></slot></label>`}updated(e){super.updated(e),e.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),e.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}l([c({type:Boolean,reflect:!0})],qe.prototype,"indeterminate",void 0),l([c({type:Boolean,reflect:!0})],qe.prototype,"invalid",void 0),l([c({type:Boolean,reflect:!0})],qe.prototype,"emphasized",void 0),h("sp-checkbox",qe);var _e=q`:host{--spectrum-picker-m-popover-offset-y:var(
--spectrum-global-dimension-size-75
...
)}`;class Pe extends g{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[_e]}render(){return s`<slot></slot>`}}l([c({type:Boolean,reflect:!0})],Pe.prototype,"opened",void 0),l([c({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Pe.prototype,"textOnly",void 0),h("sp-quick-actions",Pe);var Ie=q`:host{--spectrum-card-min-width:var(--spectrum-global-dimension-size-3000);--spectrum-card-border-size:var(--spectrum-alias-border-size-thin);--spectrum-card-border-radius:var(--spectrum-alias-border-radius-regular);--spectrum-card-actions-margin:var(--spectrum-global-dimension-size-125);--spectrum-quickactions-height:var(--spectrum-global-dimension-size-500);--spectrum-card-checkbox-margin:var(--spectrum-global-dimension-size-200);--spectrum-card-coverphoto-height:var(
...
--spectrum-global-dimension-size-50
);--spectrum-divider-margin-size:var(--spectrum-global-dimension-size-100)}:host{margin:var(--spectrum-divider-margin-size) 0}:host{display:block}`;h("sp-menu-divider",class extends g{static get styles(){return[Pt]}firstUpdated(){this.setAttribute("role","separator")}});var It=q`:host{--spectrum-progressbar-s-label-gap-y:var(
--spectrum-global-dimension-size-50
...
)}`;class Ar extends(k(g)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[$r]}render(){return s`<slot></slot>`}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}l([c({type:Boolean,reflect:!0})],Ar.prototype,"disabled",void 0),l([c({reflect:!0})],Ar.prototype,"variant",void 0),h("sp-status-light",Ar);var Sr=q`:host{--spectrum-switch-m-handle-border-size:var(
--spectrum-alias-border-size-thick
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var Er=q`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class qr extends Ze{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[Sr,Er]:[Sr]}render(){return s`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("role","switch")}updated(e){e.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}l([c({type:Boolean,reflect:!0})],qr.prototype,"emphasized",void 0),h("sp-switch",qr);var _r=q`:host{--spectrum-tabs-m-compact-item-height:var(--spectrum-alias-item-height-m);--spectrum-tabs-m-compact-vertical-item-height:var(
--spectrum-global-dimension-size-400
...
);line-height:1;margin:var(--sp-tab-vertial-margin-y) 0}#itemLabel[hidden]{display:none}`;class Pr extends(M(x(H(g,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[_r]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`${this.hasIcon?s`<slot name="icon"></slot>`:s``} <label id="itemLabel" ?hidden="${!this.hasLabel}">${this.slotHasContent?s``:this.label}<slot>${this.label}</slot></label>`}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+Pr.instanceCount++)}updated(e){super.updated(e),e.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}Pr.instanceCount=0,l([c({type:Boolean,reflect:!0})],Pr.prototype,"disabled",void 0),l([c({reflect:!0})],Pr.prototype,"label",void 0),l([c({type:Boolean,reflect:!0})],Pr.prototype,"selected",void 0),l([c({type:Boolean,reflect:!0})],Pr.prototype,"vertical",void 0),l([c({type:String,reflect:!0})],Pr.prototype,"value",void 0),h("sp-tab",Pr);var Ir=q`:host{--spectrum-tabs-m-compact-item-height:var(--spectrum-alias-item-height-m);--spectrum-tabs-m-compact-vertical-item-height:var(
--spectrum-global-dimension-size-400
);--spectrum-tabs-m-compact-vertical-item-gap:var(
--spectrum-global-dimension-size-50
);--spectrum-tabs-m-text-font-weight:var(
...
--spectrum-breadcrumb-m-item-text-color-down,var(--spectrum-alias-text-color-down)
)}`;h("sp-breadcrumb",class extends g{static get styles(){return[ro]}render(){return s`Markup goes here`}});h("sp-icon-editor-arrow-triangle",class extends i{render(){return S(s),A`<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M10 17L16 12L10 7L10 17Z"/></svg>`}});var oo=q`:host{--spectrum-tree-item-height:var(--spectrum-alias-control-height-m);--spectrum-tree-item-title-tracking:var(
--spectrum-global-font-letter-spacing-medium
...
//# sourceMappingURL=7c576de2.js.map
