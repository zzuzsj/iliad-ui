...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var Se=q`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
...
)}`;class Sr extends(z(g)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Ar]}render(){return s`<slot></slot>`}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}l([c({type:Boolean,reflect:!0})],Sr.prototype,"disabled",void 0),l([c({reflect:!0})],Sr.prototype,"variant",void 0),h("sp-status-light",Sr);var Zr=q`:host{--spectrum-switch-m-handle-border-size:var(
--spectrum-alias-border-size-thick
...
//# sourceMappingURL=c147f251.js.map
