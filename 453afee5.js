...
)}`;class Ie extends g{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[_e]}render(){return s`<slot></slot>`}}l([c({type:Boolean,reflect:!0})],Ie.prototype,"opened",void 0),l([c({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Ie.prototype,"textOnly",void 0),h("sp-quick-actions",Ie);var Pe=q`:host{--spectrum-card-min-width:var(--spectrum-global-dimension-size-3000);--spectrum-card-border-size:var(--spectrum-alias-border-size-thin);--spectrum-card-border-radius:var(--spectrum-alias-border-radius-regular);--spectrum-card-actions-margin:var(--spectrum-global-dimension-size-125);--spectrum-quickactions-height:var(--spectrum-global-dimension-size-500);--spectrum-card-checkbox-margin:var(--spectrum-global-dimension-size-200);--spectrum-card-coverphoto-height:var(
...
--spectrum-global-dimension-size-50
);--spectrum-divider-margin-size:var(--spectrum-global-dimension-size-100)}:host{margin:var(--spectrum-divider-margin-size) 0}:host{display:block}`;h("sp-menu-divider",class extends g{static get styles(){return[It]}firstUpdated(){this.setAttribute("role","separator")}});var Pt=q`:host{--spectrum-progressbar-s-label-gap-y:var(
--spectrum-global-dimension-size-50
...
)}`;class Ar extends(z(g)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[$r]}render(){return s`<slot></slot>`}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}l([c({type:Boolean,reflect:!0})],Ar.prototype,"disabled",void 0),l([c({reflect:!0})],Ar.prototype,"variant",void 0),h("sp-status-light",Ar);var Sr=q`:host{--spectrum-switch-m-handle-border-size:var(
--spectrum-alias-border-size-thick
...
);line-height:1;margin:var(--sp-tab-vertial-margin-y) 0}#itemLabel[hidden]{display:none}`;class Ir extends(M(x(H(g,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[_r]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`${this.hasIcon?s`<slot name="icon"></slot>`:s``} <label id="itemLabel" ?hidden="${!this.hasLabel}">${this.slotHasContent?s``:this.label}<slot>${this.label}</slot></label>`}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+Ir.instanceCount++)}updated(e){super.updated(e),e.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}Ir.instanceCount=0,l([c({type:Boolean,reflect:!0})],Ir.prototype,"disabled",void 0),l([c({reflect:!0})],Ir.prototype,"label",void 0),l([c({type:Boolean,reflect:!0})],Ir.prototype,"selected",void 0),l([c({type:Boolean,reflect:!0})],Ir.prototype,"vertical",void 0),l([c({type:String,reflect:!0})],Ir.prototype,"value",void 0),h("sp-tab",Ir);var Pr=q`:host{--spectrum-tabs-m-compact-item-height:var(--spectrum-alias-item-height-m);--spectrum-tabs-m-compact-vertical-item-height:var(
--spectrum-global-dimension-size-400
);--spectrum-tabs-m-compact-vertical-item-gap:var(
--spectrum-global-dimension-size-50
);--spectrum-tabs-m-text-font-weight:var(
...
//# sourceMappingURL=453afee5.js.map
