...
)}:host{display:block;overflow:hidden}img{height:auto;vertical-align:top;width:100%}`;class ze extends g{constructor(){super(...arguments),this.label="",this.src=""}static get styles(){return[ke]}render(){return i`<img alt="${a(this.label||void 0)}" src="${this.src}">`}}l([c()],ze.prototype,"label",void 0),l([c()],ze.prototype,"src",void 0),h("sp-avatar",ze);var Ce=Z`:host{--spectrum-banner-border-radius:var(
...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var $e=Z`:host{--spectrum-alias-ui-icon-triplegripper-size-100-height:var(
--spectrum-global-dimension-size-100
...
)}`;class Ee extends g{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[qe]}render(){return i`<slot></slot>`}}l([c({type:Boolean,reflect:!0})],Ee.prototype,"opened",void 0),l([c({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Ee.prototype,"textOnly",void 0),h("sp-quick-actions",Ee);var _e=Z`:host{--spectrum-card-min-width:var(--spectrum-global-dimension-size-3000);--spectrum-card-border-size:var(--spectrum-alias-border-size-thin);--spectrum-card-border-radius:var(--spectrum-alias-border-radius-regular);--spectrum-card-actions-margin:var(--spectrum-global-dimension-size-125);--spectrum-quickactions-height:var(--spectrum-global-dimension-size-500);--spectrum-card-checkbox-margin:var(--spectrum-global-dimension-size-200);--spectrum-card-coverphoto-height:var(
...
--spectrum-colorslider-border-color-disabled,var(--spectrum-global-color-gray-300)
            ...
            />
        `}firstUpdated(e){super.firstUpdated(e),this.boundingClientRect=this.getBoundingClientRect(),this.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}l([c({type:Boolean,reflect:!0})],xt.prototype,"disabled",void 0),l([c({type:Boolean,reflect:!0})],xt.prototype,"focused",void 0),l([n(".handle")],xt.prototype,"handle",void 0),l([c({type:String})],xt.prototype,"label",void 0),l([c({type:Boolean,reflect:!0})],xt.prototype,"vertical",void 0),l([c({type:Number})],xt.prototype,"value",null),l([c({type:Number,reflect:!0})],xt.prototype,"sliderHandlePosition",void 0),l([c({type:String})],xt.prototype,"color",null),l([c({type:Number})],xt.prototype,"step",void 0),l([n("input")],xt.prototype,"input",void 0),h("sp-color-slider",xt);var yt=Z`:host{--spectrum-colorhandle-size:var(--spectrum-global-dimension-size-200);--spectrum-colorwheel-border-size:var(--spectrum-alias-border-size-thin);--spectrum-colorwheel-border-color-disabled:var(
--spectrum-global-color-gray-300
...
--spectrum-global-dimension-size-50
);--spectrum-divider-margin-size:var(--spectrum-global-dimension-size-100)}:host{margin:var(--spectrum-divider-margin-size) 0}:host{display:block}`;h("sp-menu-divider",class extends g{static get styles(){return[Et]}firstUpdated(){this.setAttribute("role","separator")}});var _t=Z`:host{--spectrum-progressbar-s-label-gap-y:var(
--spectrum-global-dimension-size-50
...
)}`;class Zr extends(z(g)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Sr]}render(){return i`<slot></slot>`}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}l([c({type:Boolean,reflect:!0})],Zr.prototype,"disabled",void 0),l([c({reflect:!0})],Zr.prototype,"variant",void 0),h("sp-status-light",Zr);var qr=Z`:host{--spectrum-switch-m-handle-border-size:var(
--spectrum-alias-border-size-thick
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var Er=Z`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class _r extends Ve{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[qr,Er]:[qr]}render(){return i`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("role","switch")}updated(e){e.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}l([c({type:Boolean,reflect:!0})],_r.prototype,"emphasized",void 0),h("sp-switch",_r);var Ir=Z`:host{--spectrum-tabs-m-compact-item-height:var(--spectrum-alias-item-height-m);--spectrum-tabs-m-compact-vertical-item-height:var(
--spectrum-global-dimension-size-400
